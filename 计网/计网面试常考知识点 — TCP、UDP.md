...
#### **11、一个TCP连接连接中HTTP请求发送可以一起发送吗（比如一起发三个请求，再三个响应一起接收）？**
...
#### **18、ISN(Initial Sequence Number)是固定的吗？**
...
#### 22、简述什么是MSL，为什么客户端连接要等待2MSL的时间才能完全关闭?
...
#### **23、对于FINWAIT2，CLOSEWAIT状态和TIMEWAIT状态？你知道多少?**
...
#### **24、服务器出现大量close_wait的连接的原因是什么？有什么解决方法？**
...
#### **37、说说如果三次握手时候每次握手信息对方没收到会怎么样，分情况介绍**
...
#### **38、TCP** **与** **UDP** **在网络协议中的哪一层？各自的应用领域？**
